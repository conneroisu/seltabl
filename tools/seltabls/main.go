...
type TableStruct struct {
	...
	C string `json:"c" hSel:"html>body>div.footer>div>span>a[href]" dSel:"html>body>div.footer>div>span>a[href]" ctl:"$text"`
	D string `json:"d" hSel:"html>body>div.contentArea>table>tbody>tr.row_odd" dSel:"" ctl:"$text"`
