...
import (
	...
	"github.com/conneroisu/seltabl/seltabl-lsp/lsp"
	"github.com/conneroisu/seltabl/seltabl-lsp/rpc"
...
func handleMessage(logger *log.Logger, writer io.Writer, method string, msg []byte) {
