...
func TestSplit(t *testing.T) {
	t.Run("Split with no separator", func(t *testing.T) {
		t.Parallel()
		input := `
		// @url: https://asdf.com
		`
		expected := []string{"https://asdf.com"}
		result, err := ExtractUrls(input, t)
		assert.Nil(t, err)
	...
	t.Run("Split with a separator", func(t *testing.T) {
		t.Parallel()
		input := `
		// @url: https://elon.com
		asdf
	...
	t.Run("Split with a separator and no url", func(t *testing.T) {
		t.Parallel()
		args := []struct {
			name      string
			input     string
		...
		for _, tt := range args {
			...
			t.Run(tt.name, func(t *testing.T) {
				t.Parallel()
				result, err := ExtractUrls(tt.input, t)
